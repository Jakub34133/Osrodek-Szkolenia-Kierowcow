    ...
    <?php
        ...
        else
        {
            ...
            if(!$rezultat)
            {
                ...
                print("<p class='msg error'>Usunięcie instruktora o identyfikatorze <strong>$IdInstruktor</strong> nie powiodło się.</p>");
            }
            else
            {
                // Jeżel udało się dodać instruktora
                print("<p class='msg success'>Dane instruktora <strong>$IdInstruktor</strong> zostały usunięte z bazy.</p>");
            }
